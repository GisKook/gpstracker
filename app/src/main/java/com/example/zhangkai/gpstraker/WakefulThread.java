...
public class WakefulThread extends HandlerThread {
    ...
    protected void onPreExecute() {
        // no-op by default
        Log.i("giskook", "Wakefulthread onPreExecute");
    }
    ...
    protected void onPostExecute() {
        Log.i("giskook", "wakeful onPostExecute");
        if (lock.isHeld()) {
            lock.release();
        }
    ...
    protected void onUnlocked() {
        // no-op by default
        Log.i("giskook", "wakefulthread onunlocked");
    }

    @Override
    protected void onLooperPrepared() {
        try {
            Log.i("giskook", "wakefulthread onLooperPrepared");
            onPreExecute();
    ...
    public void run() {
        try {
            super.run();
            Log.i("giskook", "Wakefulthread run");
            ...
            Log.i("giskook", "Wakefulthread run fianal");
            onPostExecute();
        }
    }
}
